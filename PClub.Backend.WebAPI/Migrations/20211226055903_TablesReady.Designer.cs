...
namespace PClub.Backend.WebAPI.Migrations
{
    ...
    [Migration("20211226055903_TablesReady")]
    partial class TablesReady
    {
            ...
            modelBuilder.Entity("PClub.Backend.Models.Entry", b =>
                {
                    ...
                    b.Property<long>("ClubUserId")
                        .HasColumnType("bigint");

                    b.Property<Guid?>("ClubUserId1")
                        .HasColumnType("uniqueidentifier");
